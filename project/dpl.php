...
<body>
  <div class="navbar">
    ...
    <a class="nav-link" href="portal.php"><i class="fa fa-fw fa-user"></i>Login</a>
    </ul>
    </div>
    </nav>
    </div>
...
<br>
<br>
<a href="cp.php"><b>Change Password</b></a>&emsp;&emsp;&emsp;&emsp;<a href="forgot.php"><b>Forget Password?</b></a><br><br>
...
<?php 
   ...
   if(isset($_POST['login']))
   {
       ...
       $query = "SELECT * FROM doctors WHERE id = '$id' && password = '$password' " ;
