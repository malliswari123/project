...
<body>
  <div class="navbar">
    ...
    <li><a class="b" href="medical.php"><i class="fa fa-medkit"></i>Medical Portal</a></li>
    <li><a class="b" href="docavail.php"><i class="fa fa-stethoscope"></i>Availability of Doctors</a></li>
    </ul>
    <ul>
    <a class="nav-link" href="signin.php" aria-current="page"><span class="glyphicon glyphicon-pencil"></span>SignUp</a>
...
&emsp;&emsp13;&emsp13;<button type="submit" class="btn btn-success" name="login">&emsp;&emsp;&emsp;&emsp;Login&emsp;&emsp;&emsp;&emsp;</button><a href="#"></a>
</form>
<div class="signup">
...
<?php 
   ...
   if(isset($_POST['login']))
   {
       ...
       $query = "SELECT * FROM signup WHERE id = '$id' && password = '$password' " ;
